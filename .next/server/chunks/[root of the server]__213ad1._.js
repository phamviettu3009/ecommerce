...
"[project]/src/app/services/customerImpl.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class CustomerServiceImpl {
    async createAccessToken(email, password) {
        ...
        `;
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$storefront$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].request(CUSTOMER_ACCESS_TOKEN_CREATE, {
            variables: {
                email,
                password
            }
    ...
    async deleteAccessToken(customerAccessToken) {
        ...
        `;
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$storefront$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].request(CUSTOMER_ACCESS_TOKEN_DELETE, {
            variables: {
    ...
    async createCustomer(account) {
        ...
        `;
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$storefront$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].request(CREATE_CUSTOMER, {
            variables: {
                email: account.email,
...
"[project]/src/app/services/customer.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$customerImpl$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/services/customerImpl.ts [app-route] (ecmascript)");
;
const customerService = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$customerImpl$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createCustomerServiceInstance"])();
const __TURBOPACK__default__export__ = customerService;
}}),
"[project]/src/app/api/auth/sign-up/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$customer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/services/customer.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/server.js [app-route] (ecmascript)");
;
;
async function POST(request) {
    const { email, password, phone } = await request.json();
    const customer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$customer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createCustomer({
        email,
        password,
        phone
    });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__213ad1._.js.map