(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_f6b22c._.js", {
...
function useFilter() {
    ...
    const getProductFilters = async ()=>{
        const productFilters = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$client$2f$product$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getProductFilters(searchKeyword);
...
"[project]/src/app/services/client/productImpl.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class ProductServiceImpl {
    async getProducts(query, cursor) {
        const url = new URL(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$constants$2f$common$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/products${query ? "?" + query : ""}`.trimEnd());
        if (cursor) {
            url.searchParams.append("cursor", cursor);
        }
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$client$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(url.toString());
    ...
    async getProductFilters(keyword) {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$client$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/products/filter`, {
                params: {
                    search: keyword
                }
            });
...
"[project]/src/app/services/client/product.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$client$2f$productImpl$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/services/client/productImpl.ts [app-client] (ecmascript)");
;
const productService = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$client$2f$productImpl$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createProductServiceInstance"])();
...
function useProducts() {
    ...
    const getProducts = async ()=>{
        setIsLoading(true);
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$client$2f$product$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getProducts(queryParams, cursor);
        if (response) {
            setProducts((prev)=>[
                    ...prev,
                    ...response.nodes
...
//# sourceMappingURL=src_app_f6b22c._.js.map